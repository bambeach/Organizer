...
public class CameraFragment extends Fragment implements View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    /**
     * {@link OrganizerRepository} for communication with the database
     */
...
//         */
//        private final ItemImage mItemImage;
//
//        ImageSaver(Image image, ItemImage itemImage) {
//            mImage = image;
...
//            try {
//                output = new FileOutputStream(mItemImage.getFileName());
//                output.write(bytes);
//            } catch (IOException e) {
//                e.printStackTrace();
//            } finally {
